...
class TabBarController: UITabBarController {
    ...
    func setupTabs() {
        ...
        let bookModel: Book = Book(id: nil, title: "", author: "", genre: "", year: "", image: nil, status: BookStatus.available.rawValue)
        let addNew = WBooksNavigationController(rootViewController: SuggestionsViewController(viewModel: SuggestionsViewModel(bookModel: bookModel)))
